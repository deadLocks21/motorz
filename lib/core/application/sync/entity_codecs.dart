...
final fuelEntryCodec = SyncCodec<FuelEntry>(
  ...
  fromJson: (m) => FuelEntry(
    ...
    missedFillBefore: m['missed_fill_before'] as bool? ?? false,
    updatedAt: parseDate(m['updated_at']),
    deletedAt: parseDateOrNull(m['deleted_at']),
  ),
  toJson: (e) => {
    ...
    'station': e.station,
    'notes': e.notes,
    'missed_fill_before': e.missedFillBefore,
...
final costEntryCodec = SyncCodec<CostEntry>(
  ...
  fromJson: (m) => CostEntry(
    ...
    amount: doubleOrNull(m['amount']),
    recurrence: CostRecurrence.fromWire(m['recurrence'] as String?),
    date: parseDate(m['date']),
    endDate: parseDateOrNull(m['end_date']),
    notes: m['notes'] as String?,
    updatedAt: parseDate(m['updated_at']),
    deletedAt: parseDateOrNull(m['deleted_at']),
  ),
  toJson: (e) => {
    ...
    'category': e.category,
    'amount': e.amount,
    'recurrence': e.recurrence.wire,
    'date': e.date.toUtc().toIso8601String(),
    'end_date': isoOrNull(e.endDate),
    'notes': e.notes,
    'updated_at': isoOrNull(e.updatedAt),
    'deleted_at': isoOrNull(e.deletedAt),
  },
