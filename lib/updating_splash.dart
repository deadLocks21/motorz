...
/// Accent de marque Motorz (orange), identique au `theme_color` web de
/// `flutter_launcher_icons.yaml`. Codé en dur ici pour garder cette fenêtre
/// **autonome** (aucun couplage au thème de l'app, qui n'est pas initialisé
/// en mode `--updating`).
const _motorzOrange = Color(0xFFFF5A1F);

/// Mode « fenêtre de mise à jour » de l'app, lancé par l'updater :
///
///  - `motorz --updating --status <s>` : affiche directement la progression.
///  - `motorz --updating --prompt --new-version <v> --status <s> --choice <c>` :
  ...
  Widget _buildPrompt(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          'Voulez-vous mettre à jour Motorz maintenant ?',
          style: TextStyle(fontSize: 13, color: Colors.white70),
        ),
        const SizedBox(height: 20),
        FilledButton(
          style: FilledButton.styleFrom(
            backgroundColor: _motorzOrange,
