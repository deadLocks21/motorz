...
class Release {
  ...
  ///  - Windows : `motorz-windows-<v>-<run>.zip`
  ///  - Linux   : `Motorz-<v>-<run>-x86_64.AppImage`
  ReleaseAsset? get appAsset {
    final re = Platform.isWindows
        ? RegExp(r'^motorz-windows-.*\.zip$', caseSensitive: false)
  ...
  ///  - Windows : `motorz-updater-windows.exe`
  ///  - Linux   : `motorz-updater-linux`
  ReleaseAsset? get updaterAsset {
    final wanted = Platform.isWindows
        ? 'motorz-updater-windows.exe'
        : 'motorz-updater-linux';
    return _firstWhereOrNull(assets, (a) => a.name == wanted);
  }
}

/// Récupère la dernière release publiée du dépôt public Motorz.
