...
///
/// Sans argument :
///  - si Motorz est déjà installé -> MAJ silencieuse + lancement (mode launch) ;
...
Future<int> runCli(List<String> args) async {
  ...
  if (opts['help'] as bool) {
    stdout.writeln(
      'motorz-updater — installe, met à jour et lance Motorz.\n',
    );
...
Future<int> _check(Layout? existing) async {
  if (existing == null) {
    stdout.writeln('Motorz n\'est pas installé.');
    return 0;
  }
